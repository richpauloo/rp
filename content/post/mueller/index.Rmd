...
blogdown::shortcode("figure", 
                    src="/img/mueller.jpg",
                    lightbox="true",
                    title=" All 448 pages of the redacted report, with redacted setions shown in black. Source: [LA Times](https://www.latimes.com/projects/la-na-mueller-investigation-report-trump-redaction/#nt=oft-Double%20Chain~Flex%20Feature~~document-841a~~1~yes-art~curated~curatedpage) ")
```
...
```{r}
d <- pdf_text("~/Github/junkyard/mueller/report.pdf")
d <- str_replace_all(d, "\r\n", " ")
```
