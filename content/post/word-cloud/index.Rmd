...
```{r, echo=FALSE}
blogdown::shortcode("alert", .content="I've since turned this code into a simple [Shiny app that makes word clouds out of .txt files](https://richpauloo.shinyapps.io/word_cloud_app).")
```
...
```{r, echo=FALSE}
blogdown::shortcode("figure", src = "/img/YES.gif")
```
